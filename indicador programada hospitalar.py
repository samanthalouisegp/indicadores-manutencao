...
if uploaded_file is not None:
    ...
    # Para evitar o ZeroDivisionError e o TypeError, substitui os valores NaN e 0 antes da divisão
    indicador_mensal = indicador_mensal.replace([np.inf, -np.inf, np.nan], 0).astype(float).astype(int)
